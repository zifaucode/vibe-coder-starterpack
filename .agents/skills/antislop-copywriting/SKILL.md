...
description: "Copy and text skill for antislop by Miqdad Badjuber (https://github.com/miqdadbadjuber/anti-slop). Use when writing or editing prose: headlines, tone, CTAs, and anti-AI-writing patterns. Load with the core."
allowed-tools: Read Write Edit Glob Grep
---

# antislop-copywriting

> Anti AI Slop: Design & Copy Rules. Copy & Text skill by [Miqdad Badjuber](https://github.com/miqdadbadjuber/anti-slop)
...
3. The sample outranks this skill's style rules. If the sample uses em dashes, keep them at roughly the sample's frequency (R-02 still applies to any copy the user did not authorize; when the user's own sample voice uses them, the voice wins).
