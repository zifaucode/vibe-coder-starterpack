---
name: antislop-ui
description: "UI and visual skill for antislop by Miqdad Badjuber (https://github.com/miqdadbadjuber/anti-slop). Use when building or editing any interface: color, layout, components, motion. Load with the core."
allowed-tools: Read Write Edit Glob Grep
---

# antislop-ui

> Anti AI Slop: Design & Copy Rules. UI & Visual skill by [Miqdad Badjuber](https://github.com/miqdadbadjuber/anti-slop)
